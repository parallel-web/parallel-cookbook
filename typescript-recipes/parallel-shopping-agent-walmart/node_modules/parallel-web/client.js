...
var _Parallel_instances, _a, _Parallel_encoder, _Parallel_baseURLOverridden;
...
class Parallel {
     ...
     */
    constructor({ baseURL = (0, env_1.readEnv)('PARALLEL_BASE_URL'), apiKey = (0, env_1.readEnv)('PARALLEL_API_KEY'), ...opts } = {}) {
        _Parallel_instances.add(this);
        _Parallel_encoder.set(this, void 0);
        this.taskRun = new API.TaskRun(this);
        this.beta = new API.Beta(this);
        if (apiKey === undefined) {
            throw new Errors.ParallelError("The PARALLEL_API_KEY environment variable is missing or empty; either provide it, or instantiate the Parallel client with an apiKey option, like new Parallel({ apiKey: 'My API Key' }).");
        }
        const options = {
            apiKey,
            ...opts,
        ...
        this.logLevel =
            (0, log_1.parseLogLevel)(options.logLevel, 'ClientOptions.logLevel', this) ??
                (0, log_1.parseLogLevel)((0, env_1.readEnv)('PARALLEL_LOG'), "process.env['PARALLEL_LOG']", this) ??
                defaultLogLevel;
        this.fetchOptions = options.fetchOptions;
        this.maxRetries = options.maxRetries ?? 2;
        this.fetch = options.fetch ?? Shims.getDefaultFetch();
        tslib_1.__classPrivateFieldSet(this, _Parallel_encoder, Opts.FallbackEncoder, "f");
    ...
    stringifyQuery(query) {
        return Object.entries(query)
            ...
            throw new Errors.ParallelError(`Cannot stringify type ${typeof value}; Expected string, number, boolean, or null. If you need to pass nested query parameters, you can manually encode them, e.g. { query: { 'foo[key1]': value1, 'foo[key2]': value2 } }, and please open a GitHub issue requesting better support for your use case.`);
        })
            .join('&');
    }
    getUserAgent() {
    ...
    buildURL(path, query, defaultBaseURL) {
        const baseURL = (!tslib_1.__classPrivateFieldGet(this, _Parallel_instances, "m", _Parallel_baseURLOverridden).call(this) && defaultBaseURL) || this.baseURL;
    ...
    buildBody({ options: { body, headers: rawHeaders } }) {
        ...
        ArrayBuffer.isView(body) ||
            ...
            return tslib_1.__classPrivateFieldGet(this, _Parallel_encoder, "f").call(this, { body, headers });
        }
    }
}
exports.Parallel = Parallel;
_a = Parallel, _Parallel_encoder = new WeakMap(), _Parallel_instances = new WeakSet(), _Parallel_baseURLOverridden = function _Parallel_baseURLOverridden() {
    return this.baseURL !== 'https://api.parallel.ai';
};
Parallel.Parallel = _a;
Parallel.DEFAULT_TIMEOUT = 60000; // 1 minute
Parallel.ParallelError = Errors.ParallelError;
Parallel.APIError = Errors.APIError;
Parallel.APIConnectionError = Errors.APIConnectionError;
Parallel.APIConnectionTimeoutError = Errors.APIConnectionTimeoutError;
Parallel.APIUserAbortError = Errors.APIUserAbortError;
Parallel.NotFoundError = Errors.NotFoundError;
Parallel.ConflictError = Errors.ConflictError;
Parallel.RateLimitError = Errors.RateLimitError;
Parallel.BadRequestError = Errors.BadRequestError;
Parallel.AuthenticationError = Errors.AuthenticationError;
Parallel.InternalServerError = Errors.InternalServerError;
Parallel.PermissionDeniedError = Errors.PermissionDeniedError;
Parallel.UnprocessableEntityError = Errors.UnprocessableEntityError;
Parallel.toFile = Uploads.toFile;
Parallel.Beta = beta_1.Beta;
