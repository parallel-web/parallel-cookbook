...
import type { Parallel } from "../client.mjs";
 ...
 */
export declare const maybeMultipartFormRequestOptions: (opts: RequestOptions, fetch: Parallel | Fetch) => Promise<RequestOptions>;
type MultipartFormRequestOptions = Omit<RequestOptions, 'body'> & {
    body: unknown;
};
export declare const multipartFormRequestOptions: (opts: MultipartFormRequestOptions, fetch: Parallel | Fetch) => Promise<RequestOptions>;
export declare const createForm: <T = Record<string, unknown>>(body: T | undefined, fetch: Parallel | Fetch) => Promise<FormData>;
export {};
