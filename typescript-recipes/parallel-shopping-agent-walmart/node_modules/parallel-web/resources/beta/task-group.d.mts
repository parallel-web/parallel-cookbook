 ...
 */
export type TaskGroupEventsResponse = TaskGroupEventsResponse.TaskGroupStatusEvent | BetaTaskRunAPI.TaskRunEvent | BetaTaskRunAPI.ErrorEvent;
export declare namespace TaskGroupEventsResponse {
    /**
     * Event indicating an update to group status.
     */
...
//# sourceMappingURL=task-group.d.mts.map